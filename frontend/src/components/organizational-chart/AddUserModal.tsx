...
export default function AddUserModal({ isOpen, onClose, onSuccess }: AddUserModalProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await organizationalChartApi.createUser({
        name: formData.name,
      ...
      <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <div className="px-2 pr-14">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Buat user baru tanpa role/unit. User akan di-assign ke unit melalui organizational chart.
          </p>
        </div>
        <Form onSubmit={handleSubmit}>
          ...
          <div className="px-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="password_confirmation">Konfirmasi Password <span className="text-error-500">*</span></Label>
                <Input
