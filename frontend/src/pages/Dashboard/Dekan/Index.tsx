...
// Mock Data untuk Dashboard Dekan
const mockMetrics = {
  totalTugas: 156,
  tugasSelesai: 89,
  totalUnit: 8,
...
const mockChartData = {
  data: [12, 19, 15, 25, 22, 18, 20, 28, 24, 30, 26, 22],
...
export default function DashboardDekan() {
  ...
  return (
    <>
      <PageMeta
        title="Dashboard Dekan | ITS (Integrated Task System)"
        description="Dashboard untuk Dekan - Monitoring tugas dan kinerja unit"
      />
